...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-2xl border bg-card text-card-foreground shadow-card transition-all duration-300 hover:shadow-float",
        className
      )}
      {...props}
    />
...
// New glass variant for hero sections
const GlassCard = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-3xl gradient-glass border border-primary/10 shadow-soft backdrop-blur-xl transition-all duration-300",
        className
      )}
      {...props}
    />
